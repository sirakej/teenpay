...
import 'package:stripling_wallet/UI/home_dependents/bottom_nav/home_dependents/services/save_money/savings_select/target_savings_two.dart';
import 'package:stripling_wallet/utils/constants.dart';
import 'package:stripling_wallet/utils/size_config.dart';


class TargetSavings extends StatefulWidget {
  static const String id = 'TargetSavings';
  const TargetSavings({Key? key}) : super(key: key);

  @override
  _TargetSavingsState createState() => _TargetSavingsState();
}
...
class _TargetSavingsState extends State<TargetSavings> {
  ...
  /// A [TextEditingController] to control the input text for the user's email
  final TextEditingController _overallAmountController = TextEditingController();
