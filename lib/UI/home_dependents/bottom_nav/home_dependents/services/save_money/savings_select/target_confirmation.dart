...
class TargetConfirmation extends StatefulWidget {
  static const String id = 'TargetConfirmation';
  const TargetConfirmation({Key? key}) : super(key: key);

  @override
  _TargetConfirmationState createState() => _TargetConfirmationState();
}

class _TargetConfirmationState extends State<TargetConfirmation> {
