...
class RequestMoneyAll extends StatefulWidget {
  static const String id = 'RequestMoneyAll';
  const RequestMoneyAll({Key? key}) : super(key: key);

  @override
  _RequestMoneyAllState createState() => _RequestMoneyAllState();
}

class _RequestMoneyAllState extends State<RequestMoneyAll> {
  @override
