...
class RequestMoneyAccepted extends StatefulWidget {
  static const String id = 'RequestMoneyAccepted';
  const RequestMoneyAccepted({Key? key}) : super(key: key);

  @override
  _RequestMoneyAcceptedState createState() => _RequestMoneyAcceptedState();
}

class _RequestMoneyAcceptedState extends State<RequestMoneyAccepted> {
  @override
