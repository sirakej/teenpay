...
class RequestMoneyPending extends StatefulWidget {
  static const String id = 'RequestMoneyPending';
  const RequestMoneyPending({Key? key}) : super(key: key);

  @override
  _RequestMoneyPendingState createState() => _RequestMoneyPendingState();
}

class _RequestMoneyPendingState extends State<RequestMoneyPending> {
  @override
