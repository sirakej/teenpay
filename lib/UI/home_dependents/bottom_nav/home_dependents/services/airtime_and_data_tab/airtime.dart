...
class AirtimeDependents extends StatefulWidget {
  static const String id = 'AirtimeDependents';
  const AirtimeDependents({Key? key}) : super(key: key);

  @override
  _AirtimeDependentsState createState() => _AirtimeDependentsState();
}

class _AirtimeDependentsState extends State<AirtimeDependents> {
                ...
                SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MaterialButton(
                          onPressed: _AcceptShowModalSheet,
                          child: Container(
                            width: 302,
                            height: 50,
