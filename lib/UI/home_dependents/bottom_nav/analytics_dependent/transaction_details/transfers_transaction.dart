...
class TransfersTransaction extends StatefulWidget {

  static const String id = 'TransfersTransaction';
  const TransfersTransaction({
    Key? key,
  }) : super(key: key);

  @override
  _TransfersTransactionState createState() => _TransfersTransactionState();
}

class _TransfersTransactionState extends State<TransfersTransaction> {
  @override
