...
import 'package:stripling_wallet/UI/home_dependents/bottom_nav/settings_dependants/profile/profile_dependants.dart';
import 'package:stripling_wallet/UI/home_dependents/bottom_nav/settings_dependants/security_dependants.dart';
import 'package:stripling_wallet/utils/size_config.dart';
import 'customization_dependants.dart';
import 'legal_dependants.dart';

class SettingsDependants extends StatefulWidget {
  const SettingsDependants({Key? key}) : super(key: key);

  @override
  _SettingsDependantsState createState() => _SettingsDependantsState();
}

class _SettingsDependantsState extends State<SettingsDependants> {
  @override
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                         Navigator.pushNamed(context, SecurityDependants.id);
                        },
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.pushNamed(context, AccountLimitDependants.id);
                        },
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.pushNamed(context,LegalDependants.id);
                        },
                      ...
                      InkWell(
                        onTap: (){
                         Navigator.pushNamed(context,CustomizationDependants.id);
                        },
