...
class IdDocument extends StatefulWidget {
  static const String id = 'IdDocument';
  const IdDocument({Key? key}) : super(key: key);

  @override
  _IdDocumentState createState() => _IdDocumentState();
}

class _IdDocumentState extends State<IdDocument> {
